...
const CrearPartido = ({ setCrearPartido, token }) => {
    ...
    //Se piden las locaciones al backend por medio de una peticion GET
    const cargarLocaciones = async () => {
        //Se obtienen y se recorren por region para establecerlas en el hook de regiones 
    ...
    const handleSubmit = (e) => {
        e.preventDefault() //Previene el comportamiento por defecto del formulario que es recargar la pagina al mandar un formulario
        //Petición post al backend para crear un partido, la gran mayoria de las veces debe ser con un await
        //los e.target.value son los valores de los input del formulario, en este caso se envian en un objeto json
